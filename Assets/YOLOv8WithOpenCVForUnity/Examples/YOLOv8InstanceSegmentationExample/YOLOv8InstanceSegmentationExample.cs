...
namespace YOLOv8WithOpenCVForUnityExample
{
    ...
    public class YOLOv8InstanceSegmentationExample : MonoBehaviour
    {
        ...
        public string _model = "YOLOv8WithOpenCVForUnityExample/yolov8n-seg.onnx";

        [Tooltip("Optional path to a text file with names of classes to label detected objects.")]
        public string _classes = "YOLOv8WithOpenCVForUnityExample/coco.names";
        ...
        protected virtual void Run()
        {
            ...
            {
                _instanceSegmenter = new YOLOv8InstanceSegmenter(_model_filepath, _classes_filepath, new Size(_inpWidth, _inpHeight), _confThreshold, _nmsThreshold, _topK);
            }
            ...
            if (_multiSource2MatHelper.IsPlaying() && _multiSource2MatHelper.DidUpdateThisFrame())
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            // tm.stop();
                            // Debug.Log("YOLOv8InstanceSegmenter Inference time, ms: " + tm.getTimeMilli());
