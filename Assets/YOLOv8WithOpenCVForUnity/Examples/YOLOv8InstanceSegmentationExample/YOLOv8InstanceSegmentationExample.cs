...
{
    /// <summary>
    /// YOLOv8 Instance Segmentation Example
    /// Referring to:
    ...
    public class YOLOv8InstanceSegmentationExample : MonoBehaviour
    {
        // Public Fields
        [Header("Output")]
        ...
        public string Model = "YOLOv8WithOpenCVForUnityExample/yolov8n-seg.onnx";

        [Tooltip("Optional path to a text file with names of classes to label detected objects.")]
        public string Classes = "YOLOv8WithOpenCVForUnityExample/coco.names";
        ...
        // Private Fields
        private YOLOv8InstanceSegmenter _instanceSegmenter;
        ...
        private void InitializeInference()
        {
            ...
            try
            {
                ...
                if (UseSentisInference)
                {
                    _instanceSegmenter = new YOLOv8InstanceSegmenter(
                        modelPath,
                        _classesFilepath,
                    ...
                    Debug.Log("YOLOv8InstanceSegmenter initialized (Sentis / DNN_BACKEND_UNITY_SENTIS, backend=" + YoloSentisBackendType + ").");
                }
                else
#endif
                {
                    _instanceSegmenter = new YOLOv8InstanceSegmenter(
                        ...
                        NmsThreshold,
                        TopK);
                    Debug.Log("YOLOv8InstanceSegmenter initialized (OpenCV DNN).");
                }
            ...
            {
                Debug.LogWarning("YOLOv8InstanceSegmentationExample InitializeInference failed: " + ex);
            }
        }
