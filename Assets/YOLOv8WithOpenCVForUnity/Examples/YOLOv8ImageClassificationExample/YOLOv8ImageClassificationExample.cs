...
{
    /// <summary>
    /// YOLOv8 Image Classification Example
    /// Referring to:
    ...
    public class YOLOv8ImageClassificationExample : MonoBehaviour
    {
        // Public Fields
        [Header("Output")]
        ...
        public string Model = "YOLOv8WithOpenCVForUnityExample/yolov8n-cls.onnx";

        [Tooltip("Optional path to a text file with names of classes to label detected objects.")]
        public string Classes = "YOLOv8WithOpenCVForUnityExample/imagenet_labels.txt";
        ...
        // Private Fields
        private YOLOv8ImageClassifier _imageClassifier;
        ...
        private void InitializeInference()
        {
            ...
            try
            {
                ...
                if (UseSentisInference)
                {
                    _imageClassifier = new YOLOv8ImageClassifier(
                        modelPath,
                        _classesFilepath,
                        new Size(InpWidth, InpHeight),
                        MultiBackendDnn.DNN_BACKEND_UNITY_SENTIS,
                        (int)YoloSentisBackendType);
                    Debug.Log("YOLOv8ImageClassifier initialized (Sentis / DNN_BACKEND_UNITY_SENTIS, backend=" + YoloSentisBackendType + ").");
                }
                else
#endif
                {
                    _imageClassifier = new YOLOv8ImageClassifier(
                        ...
                        _classesFilepath,
                        new Size(InpWidth, InpHeight));
                    Debug.Log("YOLOv8ImageClassifier initialized (OpenCV DNN).");
                }
            ...
            {
                Debug.LogWarning("YOLOv8ImageClassificationExample InitializeInference failed: " + ex);
            }
        }
