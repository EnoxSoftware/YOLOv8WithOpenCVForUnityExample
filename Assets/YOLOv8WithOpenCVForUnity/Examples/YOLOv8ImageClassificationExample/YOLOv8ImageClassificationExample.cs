...
namespace YOLOv8WithOpenCVForUnityExample
{
    ...
    public class YOLOv8ImageClassificationExample : MonoBehaviour
    {
        ...
        public string _model = "YOLOv8WithOpenCVForUnityExample/yolov8n-cls.onnx";

        [Tooltip("Optional path to a text file with names of classes to label detected objects.")]
        public string _classes = "YOLOv8WithOpenCVForUnityExample/imagenet_labels.txt";
        ...
        protected virtual void Run()
        {
            ...
            {
                _imageClassifier = new YOLOv8ImageClassifier(_model_filepath, _classes_filepath, new Size(_inpWidth, _inpHeight));
            }
            ...
            if (_multiSource2MatHelper.IsPlaying() && _multiSource2MatHelper.DidUpdateThisFrame())
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            // tm.stop();
                            // Debug.Log("YOLOv8ImageClassifier Inference time, ms: " + tm.getTimeMilli());
