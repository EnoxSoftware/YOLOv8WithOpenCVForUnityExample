...
namespace YOLOv8WithOpenCVForUnityExample
{
    ...
    public class YOLOv8ObjectDetectionExample : MonoBehaviour
    {
        ...
        public string _model = "YOLOv8WithOpenCVForUnityExample/yolov8n.onnx";
        ...
        protected virtual void Run()
        {
            ...
            {
                _objectDetector = new YOLOv8ObjectDetector(_model_filepath, _classes_filepath, new Size(_inpWidth, _inpHeight), _confThreshold, _nmsThreshold, _topK);
            }
            ...
            if (_multiSource2MatHelper.IsPlaying() && _multiSource2MatHelper.DidUpdateThisFrame())
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            // tm.stop();
                            // Debug.Log("YOLOv8ObjectDetector Inference time, ms: " + tm.getTimeMilli());
