...
namespace YOLOv8WithOpenCVForUnityExample
{
    ...
    public class YOLOv8ObjectDetectionExample : MonoBehaviour
    {
        ...
        public string Model = "YOLOv8WithOpenCVForUnityExample/yolov8n.onnx";
        ...
        // Private Fields
        private YOLOv8ObjectDetector _objectDetector;
        ...
        private void InitializeInference()
        {
            ...
            try
            {
                ...
                if (UseSentisInference)
                {
                    _objectDetector = new YOLOv8ObjectDetector(
                        modelPath,
                        _classesFilepath,
                    ...
                    Debug.Log("YOLOv8ObjectDetector initialized (Sentis / DNN_BACKEND_UNITY_SENTIS, backend=" + YoloSentisBackendType + ").");
                }
                else
#endif
                {
                    _objectDetector = new YOLOv8ObjectDetector(
                        ...
                        NmsThreshold,
                        TopK);
                    Debug.Log("YOLOv8ObjectDetector initialized (OpenCV DNN).");
                }
            ...
            {
                Debug.LogWarning("YOLOv8ObjectDetectionExample InitializeInference failed: " + ex);
            }
        }
