...
namespace YOLOv8WithOpenCVForUnityExample
{
    ...
    public class YOLOv8ClassificationExample : MonoBehaviour
    {
        ...
        /// <summary>
        /// The YOLOv8 class predictor.
        /// </summary>
        YOLOv8ClassPredictor classPredictor;
        ...
        protected virtual void Run()
        {
            ...
            {
                classPredictor = new YOLOv8ClassPredictor(model_filepath, classes_filepath, new Size(inpWidth, inpHeight));
            }
